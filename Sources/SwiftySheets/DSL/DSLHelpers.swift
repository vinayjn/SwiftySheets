...
public func AddSheet(_ title: String) -> BatchUpdateRequest.Request {
    .addSheet(AddSheetRequest(properties: Sheet.Draft(title: title, gridProperties: Sheet.GridProperties(rowCount: 1000, columnCount: 26))))
}
